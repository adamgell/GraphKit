...
`45319d7cf4f8333697343ccf9c1089c7e04da87a8df62553cbc140089337536d`. It was merged to main as
`a1b0b8d54c17671761ef5aee017a453b072d1fe9`; exact-main CI run `33292580847` passed 772 tests
across all six Windows/macOS/Ubuntu PowerShell 7.4/7.6 jobs. This deterministic and CI evidence
is distinct from live service verification. `0.3.0` makes SecretManagement lazy for non-vault
flows and adds the live-proven TenantPulse collection descriptors described in `CHANGELOG.md`.
