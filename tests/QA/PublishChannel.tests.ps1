BeforeAll {
    ...
    function New-PassingResult {
        param([string] $Root, [string] $Version = '9.9.9', [int] $Total = 600)
...
Describe 'Publish-GraphKitPackage refusals' {
    ...
    It 'refuses a gate-failing test result' {
        ...
        @'
<?xml version="1.0" encoding="utf-8" standalone="no"?>
<test-results name="GraphKit" total="600" errors="0" failures="4" not-run="0" inconclusive="0" ignored="0" skipped="0" invalid="0" date="2026-08-15" time="12:00:00">
