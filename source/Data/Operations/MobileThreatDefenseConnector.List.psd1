<#
    ...
    Mobile Threat Defense partner connectors. Collection of connector health rows
    (partnerState, lastHeartbeatDateTime, id).
#>
@{
    SchemaVersion       = 1
    ...
    Method              = 'GET'
    PathTemplate        = '/deviceManagement/mobileThreatDefenseConnectors'
