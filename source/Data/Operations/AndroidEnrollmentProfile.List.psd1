...
@{
    ...
    ApiVersion          = 'beta'
    Stability           = 'BetaOnly'
    BetaReason          = 'Android device-owner enrollment profiles are not exposed on v1.0.'

    Method              = 'GET'
    PathTemplate        = '/deviceManagement/androidDeviceOwnerEnrollmentProfiles'
