<#
    ...
    Beta collection. Domain-join connector health is not exposed on v1.0.
#>
@{
    SchemaVersion       = 1
    ...
    ApiVersion          = 'beta'
    Stability           = 'BetaOnly'
    BetaReason          = 'Domain-join connector health is not exposed on v1.0.'

    Method              = 'GET'
    PathTemplate        = '/deviceManagement/domainJoinConnectors'
