<#
    ...
    Beta sibling of DeviceEnrollmentConfiguration.List.psd1, added so a beta-reading caller can
    be served without losing fields. Callers commonly read this collection from beta, and the
    beta shape carries properties v1.0 does not.
