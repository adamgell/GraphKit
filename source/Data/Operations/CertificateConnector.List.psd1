<#
    ...
    Beta collection consumed by IntuneHealthAutomation. NDES connector health is not exposed on v1.0.
#>
@{
    SchemaVersion       = 1
    ...
    ApiVersion          = 'beta'
    Stability           = 'BetaOnly'
    BetaReason          = 'NDES connector health is not exposed on v1.0.'

    Method              = 'GET'
    PathTemplate        = '/deviceManagement/ndesConnectors'
