<#
    ...
    Intune RBAC role definitions - the Intune roles themselves. Distinct from
    DirectoryRoleDefinition.List, which lists Entra directory roles under
    /roleManagement/directory/roleDefinitions.
#>
@{
    SchemaVersion       = 1

    Type                = 'DeviceManagementRoleDefinition'
    Operation           = 'List'
    ...
    Method              = 'GET'
    PathTemplate        = '/deviceManagement/roleDefinitions'
